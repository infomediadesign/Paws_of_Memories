...
namespace Game {
    ...
    private:
        ...
        Rectangle memoryPaste1Rec = {0.0f, 0.0f, (float) memoryPaste1.width / 36, (float) memoryPaste1.height};
        ...
        Rectangle memoryPaste3Rec = {0.0f, 0.0f, (float) memoryPaste3.width / 36, (float) memoryPaste3.height};
